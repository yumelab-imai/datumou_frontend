        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <VStack>
                ...
                <FormControl isInvalid={errors.clinicCode}>
                    ...
                    <FormErrorMessage>
                        {errors.clinicCode && errors.clinicCode.message}
                    </FormErrorMessage>
                </FormControl>
                {/* 店舗名 */}
                ...
                <FormControl isInvalid={errors.clinicPrefecture}>
                    <FormLabel htmlFor="clinicPrefectureCode">
                        都道府県
                    </FormLabel>
                    <Select
                        id="clinicPrefecture"
                    ...
                    <FormErrorMessage>
                        {errors.clinicPrefecture &&
                            errors.clinicPrefecture.message}
                    </FormErrorMessage>
                </FormControl>
                {/* クリニックの住所 */}
                <FormControl isInvalid={errors.clinicAddress}>
                    <FormLabel htmlFor="clinicAddress">
                        クリニックの住所
                    </FormLabel>
                    <Input
                        id="clinicAddress"
